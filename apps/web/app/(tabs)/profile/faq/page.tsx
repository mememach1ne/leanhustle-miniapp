...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Все товары заказываются напрямую через платформу Poizon, которая проводит собственную проверку подлинности. Каждый товар проходит аутентификацию перед отправкой покупателю.',
  },
  {
