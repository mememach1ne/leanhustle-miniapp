  ...
  return (
    <PageSection>
      ...
      {user.isChannelSubscriber ? (
        <SectionCard className="border-emerald-400/20 bg-gradient-to-br from-emerald-400/5 to-transparent">
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="shrink-0 rounded-full border border-emerald-300/30 bg-emerald-400/15 px-3 py-1 text-xs font-semibold text-emerald-200">
              Активна
            </span>
          </div>
        ...
        <div className="lg-accent-card rounded-[28px] p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              <h3 className="text-sm font-bold text-[var(--accent)]">✨ Приватный канал</h3>
              <p className="mt-1 text-xs text-white/80">
                Подпишитесь и получайте{' '}
                <span className="font-semibold text-[var(--accent)]">скидку на комиссию</span>{' '}
                при каждом заказе.
              </p>
            </div>
            <span className="shrink-0 rounded-full border border-[var(--accent)]/40 bg-[var(--accent)]/15 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-[var(--accent)]">
              PREMIUM
            </span>
          </div>
          ...
          <div className="mt-4 grid gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="lg-accent-button w-full rounded-[18px] px-4 py-3.5 text-center text-sm font-bold text-slate-950 transition active:scale-[0.98]"
            >
